...
birthday = SpecialCake('Urodzinowy', 'tort', 'orzechowy', ['orzechy', 'rodzynki'], 'marmolada', 'urodziny', 'okrągły', 'latarnia', 'z okazji urodzin')

wedding = SpecialCake('Weselny', 'tort', 'poziomkowy', ['poziomnki', 'rodzynki'], 'budyn', 'ślub', 'kwadratowy', 'serduszka', 'z okazji zaślubin')
