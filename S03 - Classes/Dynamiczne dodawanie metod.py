...
Cake.export_1_cake_to_html(cake01, '/home/adam/temp/cake01.html')

#class method
Cake.export_all_cakes_to_html = types.MethodType(export_all_cakes_to_html, Cake)
Cake.export_all_cakes_to_html('/home/adam/temp/cakes.html')
...
for c in Cake.bakery_offer:
    c.export_this_cake_to_html('/home/adam/temp/{}.html'.format(c.name.replace(' ', '_')))
